...
import de.postlab.alg.comparisonsort.insertionsort.StdInsertionsortSmpl;
 ...
 */
public class StdSelectionsortSmplTest {

    private StdSelectionsortSmpl createSorter() {
        return new StdSelectionsortSmpl();
    }
    ...
    public void insertionsort100_really_random() {
        ...
        StdSelectionsortSmpl sorter = createSorter();
        sorter.sort(arr);
    ...
    private void debug_print(StdSelectionsortSmpl sorter, int[] arr) {
        System.out.println("***************************************");
